    ...
    <div class="card-body">
      <form action="/admin/specifications/update/<?= $spec['id']; ?>" method="post" class="user" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control form-control-user <?= ($validation->hasError('spec_icon') ? 'is-invalid' : ''); ?>" id="spec_icon" name="spec_icon" placeholder="Class fontawesome" value="<?= old('spec_icon') ? old('spec_icon') : $spec['spec_icon']; ?>">
            <div class="invalid-feedback">
