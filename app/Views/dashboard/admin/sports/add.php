...
<section class="py-2">
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Tambah Olahraga</h6>
    </div>
    <div class="card-body">
      <form action="/admin/sports/save" method="post" class="user" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control form-control-user <?= (session('errors.sport_name') ? 'is-invalid' : ''); ?>" id="sport_name" name="sport_name" placeholder="Nama olahraga...">
