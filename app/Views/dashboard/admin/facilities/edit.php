...
<section class="py-2">
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Edit Facilitas</h6>
    </div>
    <div class="card-body">
      <form action="/admin/facilities/update/<?= $facility['id']; ?>" method="post" class="user" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" id="description" name="description" placeholder="Deskripsi olahraga" rows="4"><?= old('description') ? old('description') : $facility['description']; ?></textarea>
          </div>
        </div>
